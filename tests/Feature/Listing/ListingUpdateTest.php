...
it('allows the listing owner to update their listing', function () {
    ...
    $response
        ...
        ->assertJsonPath('data.category.id', $scenario['newCategory']->id)
        ->assertJsonPath('data.category.name', $scenario['newCategory']->name)
        ->assertJsonPath('data.category.slug', $scenario['newCategory']->slug)
